...
let SeatController = class SeatController {
    ...
    async getSeatsByLabId(labId, res) {
        return res
            .status(common_1.HttpStatus.OK)
            .json(new api_response_dto_1.ApiResponse(`Get seats by lab with id: ${labId} successfully`, await this.seatService.findByLabId(labId)));
    }
};
